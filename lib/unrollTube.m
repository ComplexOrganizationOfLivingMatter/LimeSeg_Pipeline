...
%         end
    ...
    if exist(fullfile(outputDir, 'verticesInfo.mat'), 'file') == 0
        ...
        [cylindre2DImage, newVerticesNeighs2D, newVertices2D, centroids, ...
            ...
            polygon_distribution, newNeighbours2D, newNeighbours2D_Checked] = mappCylindricalCoordinatesInto2D(img3d, img3dComplete, closingPxAreas2D, noValidCells, noValidCells, colours);
