...
if contains(folderName, 'Salivary gland') == 0
    ...
    FeaturesPerCell=array2table([table2array(allFeatures(:,42))./ table2array(allFeatures(:,5)), table2array(allHollowGland3dFeatures(:,2))./ table2array(allFeatures(:,5)), table2array(allFeatures(:,85))./ table2array(allFeatures(:,5))]); 
