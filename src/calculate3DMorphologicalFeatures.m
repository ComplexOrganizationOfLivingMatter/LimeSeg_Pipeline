...
if contains(folderName, 'Salivary gland') == 0
    ...
    % distribution, (Volumen,ConvexVolume and Solidity Cells), AxisLength cells, AspectRatio cells,(EquivSurfaceArea cell, Surface Area cell, 
