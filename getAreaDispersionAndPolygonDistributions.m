...
save(['docs\figuresMathPaper\lewis2D_averagePolygon_AreasDistribution_' date '.mat'],'meanScutoids','stdScutoids','meanNeighExchanges','stdNeighExchanges','meanPolyDistBasal','stdPolyDistBasal','meanPolyDistApical','stdPolyDistApical','dispersionLogNormAreaBasal','dispersionLogNormAreaApical','dispersionNormAreaBasal','dispersionNormAreaApical','listPolygons','lewisBasal_NormArea','lewisApical_NormArea')



%%Represent figures
folderSalGland = 'docs\figuresMathPaper\lewis2D_averagePolygon_AreasDistribution_08-Mar-2019.mat';
load(folderSalGland)
